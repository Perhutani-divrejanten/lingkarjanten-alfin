...
- **email**: Email portal (akan replace "lingkarjanten33@gmail.com")
- **socialHandle**: Handle social media (akan replace "lingkarjanten")
- **colors**: Tema warna
...
| `lingkarjanten` | `siteName` (tanpa spaces) |
| `lingkarjanten` | `socialHandle` |
| `lingkarjanten33@gmail.com` | `email` |
